	...
	<div class="uk-container" style="margin: 15px 0 0; padding-left: 15px; padding-right: 15px; max-width: 1000px">
		<div class="uk-grid uk-grid-small uk-grid-match" uk-margin>
			...
			<div class="uk-width-1-3@m">
				<div class="uk-background-secondary uk-padding side-menu">
					<h2 style="color: white;">Edit Template</h2>

					<ul class="uk-nav wpfc-nav" uk-switcher="connect: #settings-container">
						<?php foreach ( $tabs as $tab ) : ?>
							<li><a href="#<?php echo sanitize_title( $tab ); ?>"><?php echo $tab; ?></a></li>
						<?php endforeach; ?>
					</ul>
				</div>
			</div>
