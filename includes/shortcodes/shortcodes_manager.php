...
class Shortcodes_Manager {
	...
	public function init_elementor() {
		// Create controls.
		add_action( 'elementor/controls/controls_registered', function ( Controls_Manager $controls_manager ) {
			...
			$controls_manager->register_control( Control_Choices::get_the_type(), new Control_Choices() );
